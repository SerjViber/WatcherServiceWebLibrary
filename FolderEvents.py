...
class Handler(FileSystemEventHandler):
    ...
    def on_created(self, event):
        self.strOutput = f'Event {event.event_type} file {event.src_path} \n'
    ...
    def on_deleted(self, event1):
        self.strOutput = f'Event {event1.event_type} file {event1.src_path} \n'
    ...
    def on_moved(self, event2):
        self.strOutput = f'Event {event2.event_type} file {event2.src_path} where {event2.dest_path} \n'
